...
Prakata pemodifikasi plugin (andidepe)
Terimakasih kepada : <pre><code>git clone git://github.com/kalt/search.git</code></pre>

Plugin ini cukup bisa diandalkan untuk pencarian multi table/model. Plugin ini telah di sesuaikan dengan
cakephp 2.0 keatas dan current project.
